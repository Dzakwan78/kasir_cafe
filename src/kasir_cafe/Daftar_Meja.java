...
public class Daftar_Meja extends javax.swing.JFrame {
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(Daftar_Meja.class.getName());
    ...
    public void SelectData(){
        ...
        if(1 == -1){
            return;
        }String s = (String) tabel_meja.getModel().getValueAt(i, 1);
    }
    ...
    private void tabel_mejaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabel_mejaMouseClicked
       int i = tabel_meja.getSelectedRow();
        ...
        String id_meja = tabel_meja.getValueAt(i, 0).toString();
        Form_Transaksi.txt_idmeja.setText(id_meja);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new Daftar_Meja().setVisible(true));
    }
