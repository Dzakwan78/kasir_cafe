...
public class Form_LaporanTransaksi extends javax.swing.JFrame {
    private DefaultTableModel model;

    
    public Form_LaporanTransaksi() {
        initComponents();
        Nonaktif();
    ...
    try {
        ...
        while (r.next()) {
            ...
            o[3] = r.getString("id_pelanggan");
            o[4] = r.getString("id_meja");
            o[5] = r.getString("subtotal");
            o[6] = r.getString("total");
            o[7] = r.getString("bayar");
            o[8] = r.getString("kembali");
    ...
    try {
        Connection c = Koneksi.KoneksiDb();
        Statement s = c.createStatement();
        String sql = "Select * from transaksi Where id_pegawai like'%"+lb_idpegawai.getText()+"%'";
        ResultSet r = s.executeQuery(sql);
    ...
    private void initComponents() {
        ...
        lb_idpegawai.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        lb_idpegawai.setText("ID Pegawai");

        lb_namapegawai.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        lb_namapegawai.setText("Nama Pegawai");

        lb_jabatan.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        lb_jabatan.setText("Jabatan");

        btn_pilih.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icon/report (1).png"))); // NOI18N
    ...
    private void rb_pegawaiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rb_pegawaiActionPerformed
        ...
        btn_lihat.setEnabled(false);
        btn_caritanggal.setEnabled(false);
       Daftar_Pegawai a = new Daftar_Pegawai();
        a.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Form_LaporanTransaksi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Form_LaporanTransaksi().setVisible(true);
            }
        });
    }
    ...
    public static javax.swing.JLabel lb_namapegawai;
